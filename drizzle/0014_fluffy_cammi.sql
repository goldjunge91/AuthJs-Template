...
ALTER TABLE `bookings` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1740603981521;--> statement-breakpoint
...
ALTER TABLE `bookings` ALTER COLUMN "updated_at" TO "updated_at" text NOT NULL DEFAULT (datetime('now'));