...
ALTER TABLE `bookings` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1740536217291;--> statement-breakpoint
...
ALTER TABLE `bookings` ALTER COLUMN "updated_at" TO "updated_at" integer NOT NULL DEFAULT 1740536217291;